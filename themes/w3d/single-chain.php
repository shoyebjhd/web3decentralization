			...
			<header class="chain-dash-head">
				<div class="chain-title-row">
					<div class="chain-title-main">
						<img class="chain-logo" src="<?php echo esc_url( get_template_directory_uri() . '/assets/logos/chain-' . get_post_field( 'post_name', get_the_ID() ) . '.svg?v=orange' ); ?>" alt="" width="64" height="64" decoding="async" loading="eager">
						<?php if ( $symbol ) : ?>
