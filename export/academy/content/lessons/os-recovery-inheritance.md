...
slug: "os-recovery-inheritance"
canonical_url: "https://web3decentralization.com/lesson/os-recovery-inheritance/"
...
order: "108"
---
Nobody plans to disappear — which is why an estimated millions of Bitcoin are already lost forever. This final lesson makes sure your crypto survives you and survives disaster.
...
- Two locations minimum, different risk profiles (not two spots in one house). - Steel for fire/flood zones; paper only where climate allows. - [Multisig](https://web3decentralization.com/glossary/multisig/) holders: document *which* keys live   *where* — a finder of one key should learn nothing usable.
...
**Keep going:** the [Decentralization Analyst path](https://web3decentralization.com/course/decentralization-analyst/) path, or practice on the [terminal](https://web3decentralization.com/terminal/).
