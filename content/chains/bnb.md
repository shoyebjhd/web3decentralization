...
the front door â€” it is permissioned at the edges by the exchange's own
...
not open permissionlessness â€” so when the live score looks good on raw counts,
...
- **Validator committee size + rotation period** vs. the stake-weighted
  distribution â€” count doesn't equal spread.
