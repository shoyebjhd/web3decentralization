...
address, please return." This lesson is the checklist that keeps your first
transfers safe.
...
- **Copy-paste the address**, don't re-type it. Check the first and last 6
  characters against what the recipient actually told you.
- **Match the network exactly.** Sending an Ethereum token "on BSC" when the
