...
bank or a government to exist. It's just records on a
[blockchain](glossary/blockchain.md) that anyone can verify, and coins are
moved with [cryptography](glossary/cryptography.md) instead of a bank teller.
...
1. **A coin is a balance on a ledger, not a physical object.** "Having
   Bitcoin" means the network says your address holds it.
