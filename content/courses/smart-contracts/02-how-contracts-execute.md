...
description: "Calling a contract means sending a [transaction](glossary/transaction.md) to."
---
...
re-runs your call to verify the result â€” thousands of computers repeating
...
highest bidders first. Failed transactions still consume gas â€” the network
...
is what makes decentralized verification possible â€” and why contracts can't
...
- **Revert:** a `require` failed (bad input, insufficient balance, expired
  deadline) â€” state rolls back, but gas is still spent. Reverts protect you;
