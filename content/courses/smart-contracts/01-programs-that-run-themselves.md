...
description: "A [smart contract](glossary/smart-contract.md) is a program stored on a."
---

A [smart contract](glossary/smart-contract.md) is a program stored on a
blockchain that executes exactly as written â€” no operator, no pause button,
...
your position out of spite, or quietly edit the database â€” the code is the
entire relationship.
...
- Be patched like normal software (deployed code is final â€” upgrades need
...
dispenses the guaranteed output â€” and no pleading changes the mechanism.
