...
description: "a vault deposits into a lending pool that prices via a DEX."
---
...
protocols in a single [transaction](glossary/transaction.md) â€” atomic, so it
all succeeds or all reverts together.

## The standard stack (bottom to top)

1. **Assets** ([ERC-20s](glossary/erc-20.md), ETH, stables) â€” the raw material.
2. **DEXs/AMMs** â€” price discovery + swapping.
3. **Lending pools** â€” interest + leverage, priced by oracles.
4. **Vaults/aggregators** ([Yearn-style](glossary/yield-vault.md)) â€” automated
   strategies across 1â€“3.
5. **Front ends** â€” the website you click, which is *not* the protocol (the
   contracts work identically without it).

## Why composability multiplies both innovation and risk

- **Innovation:** a new product launches by wiring existing contracts â€”
...
cross-chain assets, who holds upgrade keys. That list *is* its risk profile â€”
...
**Next lesson:** when contracts fail â€” famous hacks as case studies.