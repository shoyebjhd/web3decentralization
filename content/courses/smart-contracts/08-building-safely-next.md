...
pro, this closing lesson is the safety doctrine plus the map onward.

## The builder's safety doctrine

1. **Start on [testnets](glossary/testnet.md).** Free tokens, real mechanics,
   zero tuition.
2. **Use battle-tested libraries** (OpenZeppelin) instead of hand-rolling
...
- **Hands-on:** deploy the storage contract from lesson 3 on a testnet;
  read one real protocol's contracts on an explorer weekly.
- **Deeper:** [DeFi 101](../defi-101/01-what-defi-replaces.md) for the
