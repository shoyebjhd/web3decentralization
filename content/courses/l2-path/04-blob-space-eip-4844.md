...
order: 4
course: l2-path
description: "Before [EIP-4844](glossary/eip-4844.md), rollups posted data as expensive L1 calldata. Now they attach [blobs](glossary/blobs.md): ~128 KB chunks o..."
---

**Objective:** understand the data layer that made cheap L2s possible â€” and its limits.
...
Fraud and validity verification only need data *while challenges are possible*. After finality, history lives with indexers and explorers â€” the protocol guarantees availability during the window that matters, not eternal storage. Separate pricing means blob demand doesn't fight your wallet's gas price (until blobs themselves congest).
...
- Blob congestion still prices out small rollups first â€” diversification across L2s isn't just tribal.
- Don't confuse cheap fees with decentralization; the sequencer question is separate.

## Related glossary

- [EIP-4844](glossary/eip-4844.md) Â· [Blobs](glossary/blobs.md) Â· [Data Availability](glossary/data-availability.md)

**Next lesson:** sequencer risks â€” the centralization hiding in plain sight.