...
|---|---|---|---|
| Stack | [OP Stack](glossary/op-stack.md) | Nitro (custom) | OP Stack |
| Sequencer | Single operator | Single operator | Coinbase |
| Governance | Collective (Token + Citizens) | DAO + treasury | Via Collective, no token |
| Bet | Superchain + public goods | Staged decentralization at scale | Distribution via Coinbase |

## Hands-on lab (free)

1. Open [L2Beat](glossary/l2beat.md) and compare the three risk tabs side by side: stage, operators, upgrade keys, exit windows.
