...
order: 2
course: l2-path
description: "Your ETH locks in an Ethereum contract; an equal amount appears on Base."
---
...
Your ETH locks in an Ethereum contract; an equal amount appears on Base. Coming back reverses it (with the ~7-day optimistic challenge window for withdrawals to L1). Every step is verifiable on both explorers â€” the bridge has no magic, only contracts you should read.

## Hands-on lab (testnet, free)

1. On Sepolia, open the official Base testnet bridge (verify domain twice).
2. Bridge 0.01 test ETH â†’ Base Sepolia. Record both transaction hashes.
...
- Never bridge during active exploit rumors â€” pause and verify on official channels.
...
- [Bridge](glossary/bridge.md) Â· [Base Chain](glossary/base-chain.md) Â· [Transaction](glossary/transaction.md)

**Next lesson:** Optimism vs Arbitrum vs Base â€” choosing your L2.