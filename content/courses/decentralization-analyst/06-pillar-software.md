...
description: "Software is the most overlooked pillar â€” and the most dangerous one."
---

Software is the most overlooked pillar â€” and the most dangerous one. It asks:
...
- A consensus-breaking bug in one buggy client takes down the *entire* chain
  â€” a self-inflicted [51%-style](glossary/51-percent-attack.md) outage with no
  attacker.
...
- **Number of independent clients** (e.g., Ethereum consensus: Prysm, Lighthouse,
  Teku, Nimbus...).
- **Usage share** â€” the real risk number. Diverse *options* with 95% running
  one client is still a 1-client network.
- **Shared code/stack** â€” "N different clients" is weaker if they share
...
| | Score | Reading |
|---|:---:|---|
| Ethereum | 88/100 | Best-in-class client diversity â€” several healthy consensus clients |
...
2. Find the real usage split (telemetry, block production share) â€” block-
...
**Next lesson:** a hands-on lab â€” scoring a chain in the terminal.