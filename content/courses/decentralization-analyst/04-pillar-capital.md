...
description: "Capital is about **who owns the network.** Token and stake distribution decide."
---

Capital is about **who owns the network.** Token and stake distribution decide
governing power and validator influence â€” and they're recorded on-chain
forever, so this is the most *auditable* pillar.

## What we actually measure

- **Stake distribution** â€” how evenly staked value is spread across
  validators. Extremely concentrated = a few giant pools run the chain.
- **Gini-style concentration** â€” one number for "how unequal is ownership?"
  (Higher = more unequal.)
- **Top-entity share** â€” the biggest whales, exchanges, and foundations.
- **Genesis/airdrop quality** â€” how the token *began*: broad airdrop or insider
...
| XRP | 35/100 | The weak pillar â€” very concentrated initial distribution |
...
capital â€” because stake decides who validates and who votes. This is exactly
...
**Next lesson:** the Governance pillar â€” who can change the rules?