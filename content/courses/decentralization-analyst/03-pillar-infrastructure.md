...
description: "Infrastructure is the most tangible pillar: **who runs the computers that run."
---
...
- **Count** â€” active validators/miners/nodes. More is a *starting point*, not
  proof.
- **Nakamoto Coefficient (infra)** â€” how many independent operators hold a
  compromising share of validating power.
- **Geographic spread** â€” nodes concentrated in one country or one data
  center are one political/engineering event away from takedown.
- **Cloud concentration** â€” if ~45% of nodes run on AWS/Hetzner, a cloud
...
| | Score | What it means |
|---|:---:|---|
| Bitcoin | 92/100 | ~17,800 nodes, >100 countries â€” the gold standard |
...
| XRP | 45/100 | Tiny default UNL validator set â€” few checkpoints, easily censored |
...
2. **How much power does one operator have?** Check the Nakamoto coefficient
   for validators/miners â€” the weakest link is what matters.
...
> Infrastructure is where "decentralized" is most often *visibly* earned â€” or
> where a snazzy website hides a server closet.

**Next lesson:** the Capital pillar â€” follow the tokens and the stake.