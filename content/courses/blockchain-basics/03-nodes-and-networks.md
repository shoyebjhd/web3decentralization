...
description: "A [node](glossary/node.md) is a computer running the blockchain's software."
---
...
different people in different places, *are* the network â€” there is no central
server room to find.
...
- **Light clients** check only proofs ([Merkle branches](glossary/merkle-tree.md))
  â€” enough for phones and browsers without downloading terabytes.
...
diversity are the real metrics â€” exactly what W3D's infrastructure pillar
scores.

## Can you run one?

On many chains, yes, on a laptop (Bitcoin, Ethereum light/full) â€” syncing
