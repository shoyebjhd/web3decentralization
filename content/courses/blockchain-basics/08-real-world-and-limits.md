...
- **Throughput vs decentralization:** fast chains usually centralize
  validation; decentralized chains are slower. The trilemma is real.
- **UX:** seed phrases, gas, and irreversible mistakes are mass-adoption
  poison. Abstraction is coming, slowly.
- **Privacy:** public-by-default ledgers surveil by design; real privacy
  needs extra tech and care.
- **Governance of the chains themselves:** upgrading decentralized protocols
  is slow, political, and occasionally fork-inducing.
...
**Keep going:** [Crypto Fundamentals](../crypto-fundamentals/01-what-is-a-blockchain.md)
for hands-on skills, or the [Decentralization Analyst](../decentralization-analyst/01-decentralization-is-not-a-buzzword.md)
path to audit networks yourself.