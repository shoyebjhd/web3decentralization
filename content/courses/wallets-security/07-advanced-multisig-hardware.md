...
wrench, one lost paper. [Multisig](glossary/multisig.md) plus hardware is how
that failure mode gets engineered away.
...
1. Buy direct from the maker. Verify the device is genuine on first boot.
...
1. **Everyone:** hot + cold split, offline backups.
2. **Serious holdings:** hardware + passphrase + steel backups.
